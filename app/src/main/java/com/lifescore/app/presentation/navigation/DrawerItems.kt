...
object DrawerNavigationConfig {
    ...
    val communityItems = listOf(
        ...
        DrawerItem("☀️ Seasonal Live Events", Icons.Default.WbSunny, Screen.SeasonalEvents.route, badge = "Live 2x", emoji = "☀️"),
        DrawerItem("📋 Goal Starter Stacks", Icons.Default.ContentPaste, Screen.HabitTemplates.route, badge = "1-Tap", emoji = "📋"),
        DrawerItem("🗳️ Identity-Based Habits", Icons.Default.HowToVote, Screen.IdentityHabits.route, badge = "Votes", emoji = "🗳️"),
